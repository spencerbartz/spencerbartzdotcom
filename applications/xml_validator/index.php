...
<div id="content-wrap">
  <div id="content">
    ...
    <div id="main">
      ...
      <div class="box">
        <h1><?php echo _('Java Apps > <span class="white">XML Validator</span>'); ?></h1>
        <p>
        Download the XML validator Java app <a href="xmlvalidator.jar" class="download-links">here</a><br/>
        </p> 
